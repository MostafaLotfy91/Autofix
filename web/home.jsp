...
<html lang="en">
    ...
    <body>
        <%
            ...
            Customer user = (Customer) s.getAttribute("userdata");
                                ...
                                <div class="product-card text-center">
                                    <div class="card-banner">
                                        ...
                                        <form method="post" action="reservation">
                                            ...
                                            <input type="hidden" name="customer_id" value="<%=usr_id%>">
                                ...
                                <%
                                    ...
                                    if (res != null) {
                                        for (Reservation reservation : res) {
                                            ...
                                            Services ser = sRepo.getServicesByPk(serviceId);
                                            int servicePrice = ser.getServicesPrice();
                                            String serviceName = ser.getServicesName();
